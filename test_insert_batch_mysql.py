...
def test_insert():
    ...
    # mysql_cursor.execute("CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (id BIGINT PRIMARY KEY, name VARCHAR(255), price FLOAT, create_time TIMESTAMP)")
    # CREATE TABLE IF NOT EXISTS test (id BIGINT PRIMARY KEY, name VARCHAR(255), price FLOAT, create_time TIMESTAMP);
    sql = doInsertSql()
